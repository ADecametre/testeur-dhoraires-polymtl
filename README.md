...
Cela évite de devenir fou en rentrant manuellement des numéros de groupe et en ayant 100 fois de suite le messsage `Il n'y a plus de places pour le groupe x`.
...
Le Testeur essaiera un par un les horaires fournis jusqu'à ce qu'il trouve un horaire disponible. Il remplit alors automatiquement tous les champs du formulaire mais ne clique pas sur le bouton `Enregistrer`.
