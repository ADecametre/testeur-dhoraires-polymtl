...
Cela évite de devenir fou en rentrant manuellement des numéros de groupe, en ayant 100 fois de suite le message `Il n'y a plus de places pour le groupe x`, puis en ayant un message d'erreur lorsque l'horaire choisi n'est plus disponible.
